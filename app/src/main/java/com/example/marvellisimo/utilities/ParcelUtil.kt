package com.example.marvellisimo.utilities
...
object SeriesSummaryRealmListParceler: RealmListParceler<SeriesSummary> {
    override val clazz: Class<SeriesSummary>
        get() = SeriesSummary::class.java
}
